 ...
 * http://notasweb.com/articulo/php/generador-de-consulta-mysql-fulltext-para-un-buscador.html
 *
 ...
 * @link        objetivophp@*****.***.** 
 * @version     2.0.0 (27/12/2009 - 05/09/2010) 
...
{  
    ...
    {  
        $this->_colParametros[] = addslashes($parametros);  
    }  
    ...
    {  
        ...
        $mySqlQuery             =/* (strlen($this->_textoDeBusqueda) < 6)?  */
                                $this->_getConsultaLike($this->_textoDeBusqueda) ;/*<--- ":"... De esta forma siempre hara esta funcion.*/
                                /*$this->_getConsultaFullText($this->_textoDeBusqueda); ... No entiendo por que esta funcion no se ejecuta correctamente, al agregar las columnas EDITORIAL y STAND en "$obj2->addCamposFullText('TITULO, AUTOR, EDITORIAL, STAND');" del index.php*/
